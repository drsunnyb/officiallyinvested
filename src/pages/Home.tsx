...
import { ArrowRight, Building2, TrendingUp, Users, BookOpen, Target, Rocket, ArrowUpRight, Youtube } from 'lucide-react';
...
export default function Home() {
  return (
    <>
      ...
      {/* Sell Your Business / Portfolio Section */}
      <section className="py-24 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#0A2540] mb-6">
              Selling a Business or Property Portfolio?
            ...
            <Link
              ...
              className="group inline-flex items-center bg-[#0A2540] text-white px-8 py-4 rounded-full font-semibold hover:bg-opacity-90 transition-all"
            >
      ...
      {/* Podcast Section */}
      <section id="podcast" className="py-24 bg-[#0A2540] text-white">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center mb-16">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col md:flex-row gap-6 justify-center">
              ...
              <Link to="/submit-opportunity" className="group inline-flex items-center bg-white/10 text-white px-8 py-4 rounded-full font-semibold hover:bg-white/20 transition-all">
