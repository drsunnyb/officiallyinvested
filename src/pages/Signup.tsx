...
export default function Signup() {
  ...
  // resume: signed-in users skip ahead
  useEffect(() => {
  ...
  const buildWorkspace = async () => {
    ...
    try {
      ...
      log('Scanning 900,000+ UK companies against your criteria…');
      try {
      ...
      <div className="max-w-xl mx-auto px-4">
        ...
        {step === 0 && (
          <div className="bg-white rounded-3xl shadow-2xl p-8">
            ...
            <input className={input + ' mt-6'} type="email" placeholder="Work email" value={email} onChange={(e) => setEmail(e.target.value)} />
